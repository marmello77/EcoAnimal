...
usando a caixinha de código abaixo:
...
3.  Pegue as suas anotações, feitas lá nos Passos Iniciais. Adicione-as
    ao mapa mental como caixas de texto, explicando cada um dos
    elementos do método científico;

4.  Não se esqueça de adicionar um cabeçalho ao mapa mental, contendo os
    nomes completos dos integrantes do grupo, seus números USP e a data
    da prática;

5.  Exporte o seu mapa mental comentado em formato PDF e carregue-o no
