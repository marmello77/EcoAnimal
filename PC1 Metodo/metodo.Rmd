...
5.  Siga o passo a passo para desenhar o mapa mental por programção, em
    linguagem R.
...
de código adicionais de que voce precisa para fazer a modificação
...
2.  Cole o seu mapa mental em um arquivo de PowerPoint ou de outro
    programa de slides ou gráfico da sua preferência;
