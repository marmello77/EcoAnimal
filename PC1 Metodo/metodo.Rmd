...
3.  Siga o passo a passo para desenhar a versão final do seu mapa mental
...
3.  Pegue as suas anotações, feitas lá nos Passos Iniciais. Adicione-as
    ao mapa mental como caixas de texto, explicando e os elementos do
    método científico;

4.  Exporte o seu mapa mental comentado em formato PDF e carregue-o no
    link do moodle para entregar o relatório.
