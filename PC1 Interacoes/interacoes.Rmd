...
Nesta prática, aprofundaremos a nossa compreensão sobre o artigo de
base, treinando também habilidades em ciência de dados.
...
1.  Identifique no texto os seguintes *elementos argumentativos*
    baseados no método científico. Descreva-os no contexto do artigo de
    base sucintamente, usando frases bem curtas. Anote essas descrições
    nas caixinhas abaixo:
...
1.  Como a Figura 3 do artigo de base se relaciona com o seu mapamental?
    Pense na operacionalização que foi feita no estudo em questão,
    transformando variáveis teóricas em variáveis operacionais, de modo
    que as ideias abstratas pudessem ser testadas empiricamente.
...
1.  Exporte este notebook com as suas respostas em formato HTML;
