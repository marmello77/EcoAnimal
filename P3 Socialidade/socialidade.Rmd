...
doação registrados no experimento. Essa frequência pode ser considerada
um termômetro da **força das relações sociais** entre os pares de
morcegos estudados:
...
Notou que existem 3 propriedades (`$`) com dados sobre os nós da rede?
Depois você pode criar novas propriedades com outras informações que
obtiver do suplemento.
...
(`weight`). Neste caso, equivalente à frequência de doação de sangue
entre pares de morcegos.
...
normalizados das frequências. Assim, o valor máximo registrado fica
sendo igual a 1, enquanto os demais ficam proporcionais a ele:
...
ficarão em azul, fêmeas em vermelho e morcegos sem o sexo identificado
em cinza.
...
nós ficam na periferia. Por tabela, eventuais subgrupos de nós
