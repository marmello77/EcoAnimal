...
Vamos começar olhando como as medidas (`cc` e `ap`) se relacionam entre
si:
...
Você pode também analisar visualmente a o quanto X faz Y variar
(**tamanho do efeito**). Basta checar a inclinação da nuvem de pontos ou
da curva de tendência, se houver. Você acha que o efeito de X sobre Y é
pequeno ou grande? Por que?
...
```{r}
fit1 = glm(dados$status2~dados$ap, family=binomial)
...
depende, a chance aumenta ou diminui com esse fator? Por que?
