...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      actionButton("clear_map", "Limpar Conexões"),  # Alterado para limpar apenas conexões
...
server <- function(input, output, session) {
  ...
  # Interface dinâmica para entrada dos rótulos dos nós
  ...
  # Limpa apenas as conexões, mantendo os nós
